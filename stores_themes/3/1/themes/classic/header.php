                        ...
                        <div class="col-xl-9 col-lg-9 col-md-8 col-sm-8">
                            <div class="header__right p-relative d-flex justify-content-between align-items-center">
                                <div class="main-menu d-none d-lg-block">
                                    <nav>
                                        <ul>
                                            <li class="active "><a href="<?php echo $that->url('') ?>">Accueil</a></li>
                                            <li class="mega-menu "><a href="<?php echo $that->url('product') ?>">Nos Produits</a></li>
                                            <li class=""><a href="<?php echo $that->url('login') ?>">Connexion</a></li>
                                            <li class=""><a href="<?php echo $that->url('signup') ?>">Inscription</a> </li>
                                        </ul>
                                    </nav>
                                </div>
