                        ...
                        <div class="row">
                                    ...
                                    <div class="product__modal-nav mr-20">
                                        <nav>
                                            <div class="nav nav-tabs" id="product-details" role="tablist">
                                                ...
                                                <div class="product__nav-img w-img">
                                                    <img src="<?php echo $that->getproduct($params)->image3?>" alt="">
                                                </div>
                                                </a>
                                            </div>
                                        </nav>
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="product__modal-content product__modal-content-2">
                                    <h4><a href="product-details.html"><?php echo $that->getproduct($params)->nom?></a></h4>
                                        ...
                                        <form action="#">
                                            ...
                                            <div class="pro-quan-area d-sm-flex align-items-center">
                                                ...
                                                <div class="pro-cart-btn">
                                                    <a href="#" class="add-cart-btn mb-20">+ Ajouter au panier</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="product__details-tab-nav text-center mb-45">
                                        <nav>
                                            <div class="nav nav-tabs justify-content-start justify-content-sm-center" id="pro-details" role="tablist">
                                                ...
                                                <a class="nav-item nav-link" id="review-tab" data-toggle="tab" href="#review" role="tab" aria-controls="review" aria-selected="false">Commentaires</a>
                                            </div>
                                        </nav>
                                    </div>
                                                ...
                                                <form action="#">
                                                    ...
                                                    <div class="pro-quan-area d-lg-flex align-items-center">
                                                        ...
                                                        <div class="pro-cart-btn ml-20">
                                                            <a href="#" class="add-cart-btn mr-10">+ Ajouter au panier</a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
